...
# #function to turn string into np array
# def floats_string_to_np_arr(floats_str):
#   def is_float(s):
#     try:
#       float(s)
...
# #function to generate new graph based on user-input
# def make_picture(training_data_filename, model, new_inp_np_arr, output_file):
#   data=pd.read_pickle(training_data_filename)
#   ages = data['Age']
#   data = data [ages > 0]
...
#   fig.add_trace(go.Scatter(x=new_inp_np_arr.reshape(len(new_inp_np_arr)), y=new_preds, mode='markers', name='New Outputs', 
